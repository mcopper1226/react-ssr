...
exports.fetchPost = exports.fetchUsers = exports.FETCH_POST = exports.FETCH_USERS = undefined;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get('https://restsims.com/wp-json/wp/v2/posts');
...
var fetchPost = exports.fetchPost = function fetchPost(path) {
  return function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _axios2.default.get('https://restsims.com/wp-json/wp/v2/posts?slug=' + path);
...
app.use('/api', (0, _expressHttpProxy2.default)('https://restsims.com/wp-json/wp/v2/posts'));
...
function loadData(store, params) {
  ...
  return store.dispatch((0, _actions.fetchPost)(params.id));
}

exports.default = {
  loadData: loadData,
  component: (0, _reactRedux.connect)(mapStateToProps, { fetchPost: _actions.fetchPost })(Post)
};
